...
| **Última atualização factual** | RC-2 Enterprise Certification (`docs/product/governance/RC-2-ENTERPRISE-CERTIFICATION.md`) — Phase 1 (Enterprise Platform Foundation) encerrada; Phase 2 (Enterprise AI Platform) iniciada. Foundation Architecture (`docs/architecture/PHASE-2-FOUNDATION-ARCHITECTURE.md`) aprovada conceitualmente pelo Architecture Review Board; Technical Design correspondente (`docs/architecture/PHASE-2-FOUNDATION-TECHNICAL-DESIGN.md`) produzido. **⚠️ A partir do Enterprise Master Execution Program (`docs/product/ENTERPRISE-MASTER-EXECUTION-PROGRAM.md`), este documento deixa de ser o eixo ativo de planejamento** — Releases 0.x e Épicos/Capabilities abaixo permanecem como registro histórico/factual (números, PRs, ADRs, Technical Debt), mas o planejamento vivo passa a ser organizado por **Wave**, não por Release. A "Nota de reconciliação" que constava aqui (Phase 2 reorganiza 0.3-0.5) está resolvida pelo Programa (§1: Waves substituem Releases 0.3-0.5 como eixo ativo). |
| **Natureza** | Artefato de **registro histórico/factual** a partir do Enterprise Master Execution Program — não substitui Blueprint, ADRs, TDS ou Technical Debt Register, e não é mais o documento de planejamento ativo (ver `docs/product/ENTERPRISE-MASTER-EXECUTION-PROGRAM.md`). |
