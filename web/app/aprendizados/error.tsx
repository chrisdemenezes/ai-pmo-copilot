...
export default function AprendizadosError({
  error,
  reset,
}: {
  ...
  const detail = error instanceof WorkspaceFetchError ? error.body.detail : undefined;

  return (
    <main className="mx-auto flex w-full max-w-6xl flex-1 items-center justify-center p-6">
      <Card className="w-full max-w-md">
        <CardContent className="flex flex-col items-center gap-3 p-12 text-center">
          <p className="text-lg font-medium">Não foi possível carregar os aprendizados agora</p>
