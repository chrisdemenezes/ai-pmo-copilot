...
describe("DashboardPage", () => {
  ...
  // Executive Narrative deixaram de viver no Dashboard, mudaram para
  // /inteligencia-executiva.
  it("no longer renders Decision Support or Narrativa Executiva (moved to Inteligência Executiva)", () => {
    render(<DashboardPage />);
    expect(screen.queryByRole("heading", { name: "Decision Support" })).toBeNull();
    expect(screen.queryByRole("heading", { name: "Narrativa Executiva" })).toBeNull();
  });
});
