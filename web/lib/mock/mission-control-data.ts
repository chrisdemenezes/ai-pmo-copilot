...
export const ENTERPRISE_PROGRAM_WAVES: WaveEntry[] = [
  ...
  },
  {
    ...
    detail: "Corresponde às Releases 0.4/0.5 já aprovadas (Integration Hub, Event Orchestration) -- não implementado. Founder autorizou o início da Wave 4 (D-070); nomenclatura oficial do roadmap harmonizada (D-071) e aprovada/concluída (D-072) -- ciclo institucional autorizado a iniciar. Enterprise Analytics (D-072) é uma capacidade transversal construída ao longo desta Wave e das Waves 5/6, não uma Wave própria.",
  },
  {
    code: "Wave 5",
