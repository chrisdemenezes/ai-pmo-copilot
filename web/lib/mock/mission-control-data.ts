...
export const ENTERPRISE_PROGRAM_WAVES: WaveEntry[] = [
  ...
  },
  {
    ...
    detail: "Corresponde às Releases 0.4/0.5 já aprovadas (Integration Hub, Event Orchestration). Founder autorizou o início da Wave 4 (D-070); nomenclatura oficial do roadmap harmonizada (D-071) e aprovada/concluída (D-072). Founder Kickoff formal (D-073): Domain Blueprint produzido -- levantamento obrigatório + modelo operacional (Event Model/Contracts/Publisher/Dispatcher, Workflow Runtime mínimo, Execution Tracking, Retry/Dead Letter, Integration Gateway, Event Audit). Decision Proposal resolvida (D-074): `pmo_workflow.py` classificado como Historical Superseded Architecture. AR-7 (D-075): Architecture Review concluída, veredito GO -- Event Envelope, Workflow Runtime, Event Publisher/Dispatcher, Integration Gateway e Conformidade arquitetural verificados item a item; 4 riscos não bloqueantes registrados para o Technical Design. Autorizado avançar ao Technical Design, mediante aprovação explícita do Founder à Architecture Review. Enterprise Analytics (D-072) é uma capacidade transversal construída ao longo desta Wave e das Waves 5/6, não uma Wave própria.",
  },
  {
    code: "Wave 5",
