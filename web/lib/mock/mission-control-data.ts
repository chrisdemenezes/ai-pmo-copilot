...
export const ENTERPRISE_PROGRAM_WAVES: WaveEntry[] = [
  ...
  },
  {
    ...
    status: "In Progress",
    detail: "Enterprise Domain completo de ponta a ponta (Sprints 1-2-5), RBAC fino (Sprint 3), Administration completo com User Management (Sprint 4 Nível 1+2 + Capability User Management -- D-038), API Keys (D-051), Sessões server-side (D-053, resolve TD-010) e Convites (D-054 -- domínio desacoplado do e-mail, entrega em NotificationProvider/NoOp). Per a Wave Completion Policy superseding (D-048), a exclusão anterior desses itens como \"Decision Proposal que não bloqueia o fechamento\" foi revogada. Restam Workspaces (entidade) e TD-008 Fase 3b; Tenant/System Settings segue Pendente de Decisão de Negócio (D-052). Wave em In Progress até o Wave Completion Review retrospectivo fechar cada item (ver WAVE-COMPLETION-REVIEW-RETROSPECTIVE.md §6).",
  },
  {
    code: "Wave 3",
