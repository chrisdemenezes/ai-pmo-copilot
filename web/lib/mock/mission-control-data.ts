...
export const ENTERPRISE_PROGRAM_WAVES: WaveEntry[] = [
  ...
  },
  {
    ...
    status: "In Progress",
    detail: "W3-1 (D-040), W3-2 Digital PMO Intelligence Foundation (D-041/D-047) e W3-3 Risk Advisor (D-046/D-047) concluídos; Security Hardening Gate (C-1/C-2) concluído (D-045). As 2 Decision Proposals pendentes (Vector Store, Framework de Orquestração) foram resolvidas, o Wave 3 Domain Blueprint (8 entregáveis, D-063) e a AR-6 (D-064) concluídos. Fase 1 (Foundation -- KnowledgeRepository/PgVectorRepository/EmbeddingProvider sobre pgvector, D-065) e Fase 2 (Knowledge Services -- RagPipeline, EnterpriseMemoryService, D-066) implementadas e testadas, sem nenhum Advisor consumidor ainda. Próximo: Fase 3 (Enterprise Advisor Framework), per o Gate de `WAVE-3-EXECUTION-PLAN.md` §7.",
  },
  {
    code: "Wave 4",
