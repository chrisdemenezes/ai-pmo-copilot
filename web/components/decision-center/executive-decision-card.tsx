 ...
 * acontece se eu não decidir, qual o próximo passo. Reaproveita a mesma
 * composição Card já usada pelos 3 Executive Briefs -- nenhuma linguagem
 * visual nova (FS-008 §3.6). Clicar leva ao Workspace do projeto,
 * fechando o Executive Loop (retorno natural).
 */
      ...
      <Card className="transition-colors hover:bg-surface-2">
        <CardContent className="flex flex-col gap-4 p-5">
          ...
          <div className="flex flex-col gap-1 rounded-md bg-surface-2 p-4">
            ...
            <p className="text-sm font-semibold text-ink">{decision.nextStep}</p>
          </div>
        </CardContent>
      </Card>
    </Link>
